...
| <a href="./scripts/patch-vulnerability/patch_vulnerability_kve_pdf.py">Patch KVE Listing</a>| Show your open patch vulnerabilities with KVE data matching the CVEs listed in patch descriptions (if any) with dates. Download <a href="./example-data-files/kve/README.md">KVE data</a> first.|
| <a href="./scripts/patch-vulnerability/patch_vulnerability_cve_with_kve_pdf.py">Patch CVE &amp; KVE Listing</a>| Show your open patch vulnerabilities with CVE and KVE data matching the CVE IDs listed in patch descriptions (if any) with dates. Generate <a href="./example-data-files/cve/README.md">CVE main CSV data</a> and download <a href="./example-data-files/kve/README.md">KVE data</a> first.|
...
| Container Scan KVE Listing| Show your open container scan vulnerabilities with KVE data matching the CVE IDs listed in patch descriptions (if any) with dates. |
| Container Scan CVE &amp; KVE Listing| Show your open container scan vulnerabilities with CVE and KVE data matching the CVE IDs listed in patch descriptions (if any) with dates. |